...
1. A [Gremlin/TinkerPop](http://tinkerpop.apache.org/)-inspired query language for Cayley.  Looks a lot like JavaScript, the syntax is documented [here](https://github.com/epik-protocol/epik-gateway-backend/blob/master/docs/GizmoAPI.md#graphv).
...
2. Example of converting the Gateway-Gremlin-Go-API query `g.V(“B”).In(“follows”).All()` into an iterator tree:
